...
GIB2A V26.3.6 is a telemetry-only Lua widget for FrSky ETHOS radios. It displays
...
[Download GIB2A V26.3.6 for ETHOS Suite](https://github.com/GIB2A/GIB2A-FrSky-ETHOS-Turbine-Telemetry/releases/download/v26.3.6/GIB2A-Xicoy-ProHub-Widget-V26.3.6-ETHOS-Suite.zip)

> **Important:** Uninstall any previous version of GIB2A before installing V26.3.6.
...
[SD package](https://github.com/GIB2A/GIB2A-FrSky-ETHOS-Turbine-Telemetry/releases/download/v26.3.6/GIB2A-Xicoy-ProHub-Widget-V26.3.6-SD.zip)
...
[ETHOS Suite package](https://github.com/GIB2A/GIB2A-FrSky-ETHOS-Turbine-Telemetry/releases/download/v26.3.6/GIB2A-Xicoy-ProHub-Widget-V26.3.6-ETHOS-Suite.zip). See
...
- [V26.3.6 release](https://github.com/GIB2A/GIB2A-FrSky-ETHOS-Turbine-Telemetry/releases/tag/v26.3.6)
- [V26.3.5 release](https://github.com/GIB2A/GIB2A-FrSky-ETHOS-Turbine-Telemetry/releases/tag/v26.3.5)
- [Compatibility](docs/COMPATIBILITY.md)
- [Configuration](docs/CONFIGURATION.md)
- [Installation](docs/INSTALLATION.md)
- [Troubleshooting](docs/TROUBLESHOOTING.md)
- [V26.3.6 release notes](docs/release-notes/V26.3.6.md)
- [V26.3.5 release notes](docs/release-notes/V26.3.5.md)
- [Xicoy ProHub - FrSky Sensor ID Reference](docs/references/GIB2A_Xicoy_ProHub_FrSky_Sensor_ID_Reference.pdf)
- [JetCat - FrSky Sensor ID Reference](docs/references/GIB2A_JetCat_FrSky_Sensor_ID_Reference.pdf)
